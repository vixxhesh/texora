  ...
  return (
    <Layout>
      <div className="resume-upload-container p-4 rounded-lg shadow-md bg-gray-50 max-w-md mx-auto mt-10">
        ...
        {isLoading && (
          <div className="w-full py-2 px-4 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 flex justify-center items-center mt-4">
            uploading...
          </div>
        )}
        {uploadMessage && (
